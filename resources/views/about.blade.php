        ...
        <div class="flex grid items-center lg:grid-cols-2">
          <div class="mb-12 lg:mb-0">
            <div class="block px-6 py-12 rounded-lg shadow-lg md:px-12 lg:-mr-14"
              ...
              <h2 class="mb-6 text-3xl font-bold">Enjoy the moment</h2>
              ...
              <div class="flex flex-col mx-auto mb-6 md:flex-row md:justify-around lg:justify-between">
                <p class="flex items-center mx-auto mb-4 md:mb-2 lg:mb-0 md:mx-0">
                ...
                <p class="flex items-center mx-auto mb-2 lg:mb-0 md:mx-0">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4 mr-2">
                    <path fill="currentColor"
                      d="M504 256c0 136.967-111.033 248-248 248S8 392.967 8 256 119.033 8 256 8s248 111.033 248 248zM227.314 387.314l184-184c6.248-6.248 6.248-16.379 0-22.627l-22.627-22.627c-6.248-6.249-16.379-6.249-22.628 0L216 308.118l-70.059-70.059c-6.248-6.248-16.379-6.248-22.628 0l-22.627 22.627c-6.248 6.248-6.248 16.379 0 22.627l104 104c6.249 6.249 16.379 6.249 22.628.001z">
                    </path>
...
<div class="container px-6 mx-auto my-24">
  ...
  <!-- Section: Design Block -->
  <section class="mb-32 text-center text-gray-800 lg:text-left">
      ...
      <div class="container mx-auto xl:px-32">
        <div class="flex grid items-center lg:grid-cols-2">
          <div class="mb-12 md:mt-12 lg:mt-0 lg:mb-0">
            <div class="relative block px-6 py-12 rounded-lg shadow-lg md:px-12 lg:-mr-14" style="
                background: hsla(0, 0%, 100%, 0.55);
                backdrop-filter: blur(30px);
                z-index: 1;
              ">
              <h2 class="mb-2 text-3xl font-bold text-blue-600">Anna Doe</h2>
          ...
          <div class="md:mb-12 lg:mb-0">
            <img src="https://mdbootstrap.com/img/new/ecommerce/vertical/080.jpg"
