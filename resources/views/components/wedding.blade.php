        ...
        <div class="flex grid items-center lg:grid-cols-2">
          <div class="mb-12 lg:mb-0">
            <div class="block px-6 py-12 rounded-lg shadow-lg md:px-12 lg:-mr-14"
              ...
              <h2 class="pb-2 mb-6 text-3xl font-bold">Wedding</h2>
              <p class="pb-2 mb-6 text-gray-500">
              ...
              <div class="flex flex-wrap mb-6">
                <div class="w-full mb-4 md:w-4/12">
                  <p class="flex items-center justify-center lg:justify-start">
                    <svg class="w-4 h-4 mr-2 text-gray-900" role="img" xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 512 512">
